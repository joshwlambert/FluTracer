...
scenarios <- data.table(
  expand.grid(
    ...
    r0_community = seq(0.1, 3.5, 0.2),
    r0_isolated = 0,
    disp_community = 0.16,
    disp_isolated = 1,
    prop_presymptomatic = c(0.01, 0.3),
    prop_asymptomatic = c(0, 0.3),
    prop_ascertain = c(0, 0.5, 1),
    initial_cases = c(5),
...
saveRDS(
  ...
  file = file.path(
    "inst", "extdata", paste0(subtype_, "_r0_analysis_", file_suffix, ".rds")
  )
)
