...
# transmission in isolation has the same dispersion as in the community
scenarios[r0_isolated > 0, disp_isolated := disp_community]
...
saveRDS(
  ...
  file = file.path("inst", "extdata", "simulations_iso_disp.rds")
)
