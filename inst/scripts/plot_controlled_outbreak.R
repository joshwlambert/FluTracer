...
h5n1_total_cases <- lapply(h5n1_results$sims, function(x) {
  ...
  total_cases[total_cases > 500] <- 500
  return(total_cases)
})
...
median_h5n1_control_outbreak <- rbindlist(h5n1_results$data)[, c("index_R0", "control_effectiveness", "delay")]
...
median_h1n1_control_outbreak <- rbindlist(h1n1_results$data)[, c("index_R0", "control_effectiveness", "delay")]
...
median_h7n9_control_outbreak <- rbindlist(h7n9_results$data)[, c("index_R0", "control_effectiveness", "delay")]
